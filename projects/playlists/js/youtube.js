...
// filtrar as musicas correspondentes à playlist
const filterMusics = () => {
...
const addMusic = (musicName, link, playlist) => {
  const li = `
    <li class="list-group-item d-flex justify-content-between align-items-center" playlist="${playlistName}">
    ${musicName}
...
// console.log(playlistList.firstElementChild);
